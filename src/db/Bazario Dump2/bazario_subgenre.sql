...
CREATE TABLE `subgenre` (
  ...
  CONSTRAINT `subgenre_ibfk_1` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id_genre`) ON DELETE CASCADE
...
INSERT INTO `subgenre` VALUES (1,'Smartphones',1),(2,'Laptops',1),(3,'Fiction',2),(4,'Non-Fiction',2),(5,'T-Shirts',3),(6,'Jeans',3);
